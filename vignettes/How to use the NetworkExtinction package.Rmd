...
The objective of the NetworkExtinction package is to analyze and visualize extinctions in a food network.

## How to install the package

### Extinctions from most connected to less conected

The function to do this analisis is called *MostConected*
